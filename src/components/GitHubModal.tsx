...
git init
git add .
git commit -m "feat: Evermotion living physics universe initial release"

# 2. Add your GitHub repository remote & push
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/evermotion-game.git
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5 text-sm">
          ...
          <div className="p-3.5 bg-amber-500/10 border border-amber-500/30 rounded-2xl flex items-start gap-3">
            ...
            <div className="text-xs text-amber-200/90 leading-relaxed">
              To publish this code under your personal GitHub account (<code>kapilnarula27july@gmail.com</code>), follow these 3 quick steps to push the repository or deploy directly to GitHub Pages / Vercel.
            </div>
          </div>
          ...
          <div className="p-4 bg-slate-800/40 border border-slate-800 rounded-2xl space-y-2">
            ...
            <p className="text-xs text-slate-300">
              Go to GitHub and create a new repository called <code>evermotion-game</code> (leave "Initialize with README" unchecked).
            </p>
          </div>
          ...
          <div className="p-4 bg-slate-800/40 border border-slate-800 rounded-2xl space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="font-bold text-xs uppercase tracking-wider text-amber-400 flex items-center gap-1.5">
                <Terminal className="w-3.5 h-3.5" /> Step 2: Push to Your Repository
              </span>
              <button
